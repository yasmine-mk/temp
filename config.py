...
config = {
    ...
    "model_param": (7,),  # the input of the model, used to initialize the model
    "inp_size": (784,),  # the input shape
    "train_path": "train1/",  # the path to the train data
    "test_path": "test1/",  # the path to the test data
