...
config = {
    ...
    "optimizer": FedProx,  # FL optimizer, can be FedAvg, FedProx, FedCurv or SCAFFOLD
    ...
    "gamma": 0.1,  # the value of gamma when FedReg is used, the weight for the proximal term when FedProx is used, or the value of lambda when FedCurv is used
    "iid": True
}